...
Future<void> _loadActivities() async {
  ...
  try {
    ...
    final response = await _supabase.from('actividad_conservacion').insert(activityData);
  ...
  _selectedCategory = Categories.values.first; // Seleccionar el primer valor válido
